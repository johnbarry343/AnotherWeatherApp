...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        ...
        long row_id = TestUtilities.insertNorthPoleLocationValues(this.mContext);
        assertTrue(row_id != -1);
        ...
        // query if you like)
        TestUtilities.validateCurrentRecord(null, c, cv);
    ...
    public void testWeatherTable() {
        ...
        ContentValues weatherValues = TestUtilities.createWeatherValues(row_id);
        // Insert ContentValues into database and get a row ID back
        long weatherRowId;
