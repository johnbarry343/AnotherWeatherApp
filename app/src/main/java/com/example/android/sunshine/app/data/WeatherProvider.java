...
public class WeatherProvider extends ContentProvider
{
    ...
    static UriMatcher buildUriMatcher()
    {
        ...
        tempUriMatcher.addURI(authority, WeatherContract.PATH_WEATHER, WEATHER);
        tempUriMatcher
                .addURI(authority, WeatherContract.PATH_WEATHER + "/*", WEATHER_WITH_LOCATION);
        tempUriMatcher.addURI(authority, WeatherContract.PATH_WEATHER + "/*/#",
                WEATHER_WITH_LOCATION_AND_DATE);
        tempUriMatcher.addURI(authority, "location", LOCATION);
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs)
    {
        ...
        switch (match)
        {
            case WEATHER:
                ...
                {
                    rowsDeleted = db
                            .delete(WeatherContract.WeatherEntry.TABLE_NAME, "1", selectionArgs);
                }
                else
                {
            ...
            case LOCATION:
                ...
                {
                    rowsDeleted = db
                            .delete(WeatherContract.LocationEntry.TABLE_NAME, "1", selectionArgs);
                }
                else
                {
